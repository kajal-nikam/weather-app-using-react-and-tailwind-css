...
function Highlights({ stats }) {
  return (
    <div className="bg-slate-600 p-4 text-slate-200 flex flex-col justify-start items-center sm:p-2 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out">
